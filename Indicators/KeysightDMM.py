...
class Keysight_3458A:
    def __init__(self, bus_connection:str = "GPIB1",simulation = True):
        ...
        self.alcances = {0:"100 mV",1:"1 V",
                         2:"10 V", 3:"100 V",
                         4:"1000 V"}
        self.alcancesRes= {0:"10 ",1:"100",2:"1000",3:"10000",4:"100000",
                     5:"1000000",6:"10000000"7,:"100000000",8:"1000000000"}
    ...
    def ACVSYNC(self,alcance : int = 1):
        ...
        return 0
    ## OHM
    def RES(self,WIRE,alcancesRes: int = 1):
        if not self.SIM:
            self.inst.write(f"FUNC {WIRE} {alcancesRes}")
            if WIRE == "OHMF" :
                self.SET_Ndig(8)
                self.SET_NPLC(100)
                self.SET_OCOMP("ON")
